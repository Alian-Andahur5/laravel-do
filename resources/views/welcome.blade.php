...
<div id="index-banner" class="parallax-container">
  <div class="section no-pad-bot">
    <div class="container">
      ...
      <div class="row center">
        <a href="http://materializecss.com/getting-started.html" id="download-button" class="btn-large waves-effect waves-light teal lighten-1">Comenzar lecciones</a>
      </div>
      <br><br>
  ...
  <div class="section">
    ...
    <div class="row">
      <div class="col s12 center">
        ...
        <div class="fb-comments" data-href="http://www.alianandahur.cl/" data-width="50px " data-numposts="5"></div>
        <p class="left-align light"> ajhsdgjashdkajskhdkaaaaaaaaaaaaksjhdkajshdkjahsdkahsdjkhaskjhdakjshdkajhsdkjahsd</p>
